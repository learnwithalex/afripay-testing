        ...
        <div className="bg-dull h-screen w-full">
              <div className="flex flex-col h-full w-full items-center justify-center">
                    <div className="w-full h-1/2 text-right p-5">
                        ...
                        <img src={one} className="h-[23rem]" alt="" />
                    </div>

                    <div className="h-1/2 w-full p-3 flex items-end">
                          <div className="rounded-[40px] w-full p-5 text-center bg-white">
                                  ...
                                  <p className="px-4 py-2 text-sm text-txtblue font-medium">Get an overview of how you are performing and motivate yourself to achieve even more.</p>

                                  <img src={sliders} className="inline-block py-1" alt="" />
                                  <br></br>
