  ...
  return (
    ...
    <div className="flex flex-col items-stretch w-full h-screen bg-[rgba(44,20,221,0.06)]">
        ...
        <div className="mt-7 h-1/2">
                  <div className="px-5">
                        <h1 className="text-xl text-[#282061] font-bold">
                          Enter your email and we'll send you a link to reset your password
                        </h1>
                  </div>

              {/* form-start */}
                  <div className="px-4 my-5 form-group">
        ...
        <footer className="flex items-end w-full h-1/2">
                <div className="flex items-center w-full p-3 justify-evenly btn-group">
                        <button className="w-full px-5 py-3 mb-5 text-white text-md bg-[#2c14dd] rounded-[50px] focus:outline-none">Continue</button>
                </div>
        </footer>
        {/* button footer end */}
    </div>
