     ...
     <div className="flex flex-col items-stretch w-full h-screen bg-[rgba(44,20,221,0.06)]">
              ...
              {/* form-start */}
                  <div className="px-6 my-5 form-group">
                            ...
                            <div className="w-full px-3 py-1 my-5 bg-white rounded-2xl email-form">
                                ...
                                <input type="text" name="name" id="name" placeholder="Louis Real" className="w-full px-2 py-1 text-lg bg-none focus:outline-none" />
                          </div>
        ...
        <footer className="flex items-end w-full h-1/2">
                <div className="flex items-center w-full p-3 justify-evenly btn-group">
                        ...
                        <button className="w-1/2 px-5 py-5 text-white text-xl bg-[#2c14dd] rounded-[50px] focus:outline-none">Register</button>
                </div>
        </footer>
        {/* button footer end */}
     </div>
