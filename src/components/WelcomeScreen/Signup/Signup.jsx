     ...
     <div className="flex flex-col items-stretch w-full h-screen bg-[rgba(44,20,221,0.06)]">
        ...
        <div className="mt-7 h-1/2">
              ...
              {/* form-start */}
                  <div className="px-6 my-5 form-group">
                            ...
                            <div className="w-full px-3 py-1 my-3 bg-white rounded-2xl email-form">
                          ...
                          <div className="relative w-full px-3 py-1 my-3 bg-white rounded-2xl password-form">
        ...
        <footer className="flex items-end w-full h-1/2">
                <div className="flex items-center w-full p-3 justify-evenly btn-group">
                        ...
                        <button className="w-1/2 px-5 py-3 text-white text-md bg-[#2c14dd] rounded-[50px] focus:outline-none">Register</button>
                </div>
        </footer>
        {/* button footer end */}
     </div>
